function [t,exp] = simulation_neel(B, t_vec, varargin)
...
% solve system
jac = @(t,y)neel_odesys(t,y,1, B, m_offset, m_b3, m_bp, m_bm,tau_N);
opts = odeset("Vectorized", "on","Jacobian", jac, "RelTol", 1e-3);
%opts = odeset( 'RelTol', 1e-3);
rhs = @(t,y)neel_odesys(t,y,0, B, m_offset, m_b3, m_bp, m_bm,tau_N);
